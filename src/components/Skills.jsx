    ...
    <Box  id="skills" >
      ...
      <Text data-aos="flip-down" data-aos-duration="1500" textAlign={"center"} w={"max-content"} m={" 20px auto"} fontWeight="700">
        <Button fontSize={["xs", "sm", "2xl", "2xl"]} mb={"10px"} textAlign={"center"} onClick={() => setSkillShow((p) => !p)}
          ...
          color={"white"}
          bg={"rgb(241, 157, 16)"}>{skillshow ? "See Front" : " See Back"}
          End
        </Button>
      </Text>
      ...
      <Box id='skill-container-inner'  className="skills-card"  >
        ...
        <Box id='skills_left'  className="skills-card-name"  >
          {skillshow ? (<Box className='left_dup' data-aos="fade-up" data-aos-duration="1000">
            ...
            <Text className='skillNameTitle' data-aos="fade-up" data-aos-duration="1000" margin={"auto"} mb={"20px"} border={"1px solid"}>Front End </Text>
            <Box id='frontend_skills' data-aos="fade-up" data-aos-easing="ease-out-cubic" >
        ...
        <Box id='skills_right'  className="skills-card-name" >
          {skillshow ? (<Box id='right_real'  >
            ...
            <Text className='skillNameTitle' mb={"20px"} data-aos="fade-up" data-aos-duration="1000" border={"1px solid"}>Back End </Text>
            <Box className='back_end_skills' data-aos="fade-up" data-aos-easing="ease-out-cubic" >
          ...
          </Box>) : (<Box className='right_dup' data-aos="fade-up">
            <img  className='skills-card-img' src="https://phpdots.com/wp-content/uploads/2021/12/api-backend-banner.svg" alt="front end" />
          </Box>)}
      ...
      <Box id='OtherSkills_container' class="skills-card" mt={"10px"}>
        <Text data-aos="zoom-out-up" className='tool' data-aos-duration="1000" textAlign={"center"} fontSize={"4xl"} m={"auto"} border={"1px solid"} w={"max-content"} color={"rgb(241, 157, 16)"} fontWeight={"700"}>Tools</Text>
